...
export const ACHIEVEMENTS = [
    ...
    { id: 'advanced_clear', title: '進階入門', description: '首次完成進階模式全鍵盤通關', icon: '🌱' },
    { id: 'advanced_perfect', title: '進階零漏接', description: '進階全鍵盤通關且未用到寬限機會', icon: '💎' },
    { id: 'advanced_master', title: '進階大師', description: '累計通關進階模式 10 次', icon: '🏆' },
